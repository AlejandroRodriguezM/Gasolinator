...
public class FuncionesManejoFront {
	...
	public static ImageView imagenEvento;
	...
	public static void establecerAnchoColumnas(double numColumns) {
		for (TableColumn<Evento, String> columna : AccionReferencias.getListaColumnasTabla()) {
	...
	public static void cambiarEstadoMenuBar(boolean estadoAccion, AccionReferencias referenciaVentana) {
		...
		disableButtons(estadoAccion, referenciaVentana.getBotonIntroducir(), referenciaVentana.getBotonModificar(),
				...
				referenciaVentana.getBotonGuardarEvento(), referenciaVentana.getBotonGuardarCambioEvento(),
				referenciaVentana.getBotonEliminarImportadoEvento(), referenciaVentana.getBotonParametroEvento(),
...
//			tableView.getItems().clear();
	...
	public static void cambiarEstadoOpcionesAvanzadas(boolean estadoAccion, AccionReferencias referenciaVentana) {
		if (referenciaVentana != null) {
			...
			deshabilitarSiNoNulo(referenciaVentana.getBotonEliminarImportadoListaEvento(), estadoAccion);
			deshabilitarSiNoNulo(referenciaVentana.getBotonGuardarListaEventos(), estadoAccion);
		}
	}
