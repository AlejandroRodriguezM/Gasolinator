...
import Dbmanager.DbDeleteManager;
...
public class CalculadorPagos {
	...
	public void ajustarPagosParaBolo(Concierto concierto) {
		...
		for (Musico musico : musicos) {
			Evento evento = new Evento(musico.getIdConcierto(), // Identificador del concierto
			...
			DbInsertManager.insertViaje(evento);
		}
	}
	...
	public static void main(String[] args) {
		...
		DbInsertManager.insertarCantantes();

		DbDeleteManager.deleteTablaViaje();
...
//		String idConcierto, String nombreConcierto, String fechaConcierto, List<Musico> musicos
		...
		DbInsertManager.insertViaje(concierto);
