...
public class DbInsertManager {
	...
	public static void insertViaje(Evento evento) {
		...
		try (PreparedStatement pstmt = DbConnection.getConnection().prepareStatement(SQL_INSERT_VIAJE)) {
	...
	public static void insertViaje(Concierto concierto) {
		...
		try (PreparedStatement pstmt = DbConnection.getConnection().prepareStatement(SQL_INSERTAR_CONCIERTO)) {
			// Asigna los parámetros del PreparedStatement basados en el objeto Evento.
	...
	public static void insertarCantantes() {
		...
		try (PreparedStatement pstmt = DbConnection.getConnection().prepareStatement(SQL_INSERTAR_MUSICOS)) {
